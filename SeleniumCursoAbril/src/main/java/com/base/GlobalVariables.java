...
public class GlobalVariables {
	...
	public static final String QA_URL = "https://opensource-demo.orangehrmlive.com/index.php/auth/login";
	...
	public static final String JSON_KEY_INVALIDPWD = "invalidPassword";
